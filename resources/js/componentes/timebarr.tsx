...
export const TimesBar= ({ diasColoridos, diasBloqueados }) => {
  ...
  const handleDateChange = async (date) => {
    ...
    setFechaSeleccionada(date.toLocaleDateString('sv-SE'));
  };
    ...
    <div className=" p-8 row justify-content-around">
      ...
      <div className="Formulario col-4 justify-content-start"> <div className="row">
        <div className="col-5">
          ...
          <input type="time" id="hora" value={time} onChange={handleTimeChange} name="appt-time" className="form-control" />
        ...
        </div> <div className="col-5"> <label htmlFor="Pago">Forma de Pago</label>
